...
// Usage: node delete_collection.js <collection_name>
// Collection names: season_stats, weekly_stats, roster_data, or 'all'
// Example: node delete_collection.js season_stats
...
function parseArguments() {
  ...
  if (args.length === 0) {
    ...
    console.log('');
    console.log('Usage: node delete_collection.js <collection_name>');
    console.log('');
    ...
    console.log('  node delete_collection.js season_stats');
    console.log('  node delete_collection.js all');
    process.exit(1);
  }
